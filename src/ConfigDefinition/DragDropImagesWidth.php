...
class DragDropImagesWidth extends StringSetting implements IOverwriteGlobal {
	...
	public function getGlobalName() {
		return "wgEnhancedUploadDragDropImagesWidth";
	}
	...
	public function getLabelMessageKey() {
		return 'enhancedupload-config-width-label';
	}
	...
	public function getHelpMessageKey() {
		return 'enhancedupload-config-width-help';
	}
}
